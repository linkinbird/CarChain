...
class Encoder {
  ...
  static encodeParam(type, value) {
    console.log("encodeParam:",type,value)
    ...
    if (type.match(Constants.ADDRESS)) {
      ...
      console.log("current type is bytes32 ",type,value);
  ...
  static addressToHex(address) {
    ...
    static addressToHexAddress(address) {
        if (!address) {
            throw new Error('address should not be undefined');
        }
        ...
        return "0x"+Web3Utils.padLeft(hexAddr, 32);;
    }
  ...
  static stringToHex(string, maxCharLen) {
    ...
    // console.log("str2hex",string,hexString);
...
//
//     var s1 = '111';
//     var s2 = Encoder.stringToHex( s1,64);
//     console.log('s2:',s2, bytes(s1));
//     var s3 = Encoder.stringToHex( s2,64);
//     console.log('s3:',s3);
//     var s4 = Encoder.stringToHex( s3,64);
//     console.log('s4:',s4);
//
// }
//
